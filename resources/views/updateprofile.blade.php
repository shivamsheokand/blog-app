    ...
    <div class="form-container1">
      ...
      <form action="/updateprofile" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="passion" class="form-control1" id="passion" placeholder="Enter your passion" value="{{$user->passion}}">
        </div>
        <div class="mb-3">
          <img src="{{ isset($user) && $user->img ? url('storage/'.$user->img) : url('storage/'.$user->img) }}" 
